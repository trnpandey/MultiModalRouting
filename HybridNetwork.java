 ...
 static int v ;
   ...
   Map<String, Double> latlon ;
    public static void setMap() throws IOException {
         ...
         BufferedReader in=new BufferedReader(new FileReader("/home/akshita/Desktop/gis/unqbusstopddf.csv"));
        String line = "";
             v = 0 ;
	...
	stationlatlon = new HashMap<String,String>() ;
	 ...
	 BufferedReader inn=new BufferedReader(new FileReader("/home/akshita/Desktop/gis/MetroStation.csv"));
    ...
    lon1 = 0.0 ;
    lon2  = 0.0 ;
    BufferedReader br=new BufferedReader(new FileReader("/home/akshita/Desktop/gis/buslatlon.csv"));
  line = "" ;
...
else
{
  ...
  BufferedReader inp=new BufferedReader(new FileReader("/home/akshita/Desktop/gis/MetroStation.csv"));
    line = "" ;
     prev = "" ;
     prevstop = 5500 ; 
     lat1 = 0.0 ;
...
BufferedReader b1=new BufferedReader(new FileReader("/home/akshita/Desktop/gis/bus_metrolatlon.csv"));
String line="";
String temp1="";
...
for(int k=0;k<inter.length;k++)
{
	...
	{
	b1=new BufferedReader(new FileReader("/home/akshita/Desktop/gis/bus_metrolatlon.csv"));
